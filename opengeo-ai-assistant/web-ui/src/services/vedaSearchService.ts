...
class VEDASearchService {
   ...
   */
  private async searchCollectionsTextOnly(
    query: string,
    collection_id?: string
  ): Promise<VEDACollection[]> {
    try {
  ...
  private async getQueryEmbeddings(query: string): Promise<number[]> {
    try {
      ...
      throw new Error(
        `Failed to generate query embeddings: No working embedding deployment found. Last error: ${lastError.message}`
      );
    } catch (error: any) {
  ...
  private getSimulatedCollections(query: string, collection_id?: string): VEDACollection[] {
    ...
    const allCollections: VEDACollection[] = [
      {
        ...
        description:
          'Landsat Collection 2 Level-2 surface reflectance products from multiple sensors (TM, ETM+, OLI). Contains multispectral optical imagery ideal for land use monitoring and agricultural analysis.',
      ...
      },
      {
        ...
        description:
          'High-resolution optical imagery from ESA Sentinel-2 satellites with atmospheric correction. Provides detailed surface reflectance data perfect for vegetation monitoring and land cover analysis.',
      ...
      },
      {
        ...
        description:
          'Moderate Resolution Imaging Spectroradiometer data from Terra and Aqua satellites. Daily global coverage with excellent temporal resolution for monitoring environmental changes.',
      ...
      },
      {
        ...
        description:
          'Global digital elevation model derived from SRTM and other elevation sources. Essential for topographic analysis, watershed studies, and terrain modeling.',
      ...
      },
      {
        ...
        description:
          'Advanced Spaceborne Thermal Emission and Reflection Radiometer data. Combines VNIR, SWIR, and thermal infrared data for comprehensive Earth observation.',
      ...
      },
      {
        ...
        description:
          'Geostationary weather satellite data with high temporal resolution. Perfect for meteorological analysis, cloud tracking, and atmospheric monitoring.',
      ...
      },
      {
        ...
        description:
          'Visible Infrared Imaging Radiometer Suite nighttime lights and low-light imagery. Excellent for studying human activity patterns and nighttime Earth observation.',
      ...
      },
      {
        ...
        description:
          'Comprehensive atmospheric reanalysis from ECMWF covering weather and climate variables. Contains temperature, precipitation, wind, and other atmospheric parameters.',
    ...
    return filteredCollections
      .filter((collection) => {
        ...
        return (
          queryKeywords.some((keyword) => lowerQuery.includes(keyword) && text.includes(keyword)) ||
   ...
   */
  private async simulateVEDASearch(
    query: string,
    collection_id?: string
  ): Promise<VEDASearchResponse> {
    ...
    if (queryLower.includes('temperature') || queryLower.includes('thermal')) {
      collections = [
        {
          ...
          description:
            'Comprehensive global temperature measurements from the ERA5 reanalysis dataset.',
      ...
      queryLower.includes('pressure') ||
      queryLower.includes('blizzard') ||
      queryLower.includes('atmospheric') ||
      ...
      collections = [
        {
          ...
          description:
            'ERA5 mean sea level pressure data during blizzard events, providing insights into atmospheric conditions during extreme weather.',
...
This dataset is particularly valuable for understanding how atmospheric pressure drives the formation and intensity of blizzard conditions, helping meteorologists predict future severe winter weather events.`;
      ...
      queryLower.includes('precipitation') ||
      ...
      collections = [
        {
          ...
          description:
            'Global Precipitation Measurement mission data providing comprehensive rainfall and snowfall measurements.',
          relevance_score: 0.9,
        },
      ];
      ...
      collections = [
        {
          ...
          description:
            'MODIS-derived sea surface temperature measurements for ocean climate studies.',
      ...
      collections = [
        {
          ...
          description:
            'Comprehensive collection of NASA Earth Science datasets covering climate, weather, and environmental data.',
          relevance_score: 0.8,
        },
      ];
