...
class TiTilerQualityConfig:
    ...
    THERMAL_COLLECTIONS = ["landsat-c2-l2"]  # Has thermal bands
    ...
    def get_optimal_params(
        cls, collection_id: str, query_context: Optional[str] = None
    ) -> Dict[str, any]:
        """
        ...
        is_thermal = query_context and any(
            kw in query_context.lower()
            for kw in ["thermal", "temperature", "heat", "infrared"]
        )
        ...
        # Thermal data configuration
            ...
            params["assets"] = (
                "ST_B10"  # Landsat Surface Temperature Band 10 (correct asset name)
            )
            params["bidx"] = 1
