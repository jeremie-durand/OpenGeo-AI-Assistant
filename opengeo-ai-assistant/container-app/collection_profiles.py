...
COLLECTION_PROFILES = {
    "sentinel-2-l2a": {
        ...
        "temporal": {"start": "2015-06-27", "end": "ongoing"},
    ...
    "landsat-c2-l1": {
        ...
        "query_rules": {
            ...
            "required_params": ["bbox"],
            "supported_params": ["bbox", "datetime", "limit", "collections"],
            "ignored_params": ["query.eo:cloud_cover"],
            "capabilities": {
                "temporal_filtering": True,
    ...
    "landsat-c2-l2": {
        ...
        "temporal": {"start": "1982-08-22", "end": "ongoing"},
    ...
    "modis-43A4-061": {
        ...
        "temporal": {"start": "2000-02-16", "end": "ongoing"},
    ...
    "modis-09A1-061": {
        ...
        "query_rules": {
            ...
            "required_params": ["bbox"],
            "supported_params": ["bbox", "sortby", "limit", "collections"],
            "ignored_params": ["datetime", "query.eo:cloud_cover", "query.cloud_cover"],
            "capabilities": {
    ...
    "sentinel-1-grd": {
        ...
        "temporal": {"start": "2014-10-10", "end": "ongoing"},
    ...
    "alos-palsar-mosaic": {
        ...
        "query_rules": {
            "type": "dynamic_timeseries",
            "required_params": ["bbox"],
            "supported_params": ["bbox", "datetime", "limit", "sortby"],
            "ignored_params": ["query.eo:cloud_cover"],
            "capabilities": {
                "temporal_filtering": True,
                "cloud_filtering": False,
    ...
    "alos-dem": {
        ...
        "query_rules": {
            ...
            "required_params": ["bbox"],
            "supported_params": ["bbox", "limit", "collections"],
            "ignored_params": ["datetime", "query.eo:cloud_cover", "query.cloud_cover"],
            "capabilities": {
    ...
    "hls2-l30": {
        ...
        "temporal": {"start": "2020-01-01", "end": "ongoing"},
...
""",
    ...
    "3dep-seamless": {
        ...
        "query_rules": {
            "type": "static_elevation",
            "required_params": ["bbox"],
            "supported_params": ["bbox", "limit"],
            "ignored_params": ["datetime", "query.eo:cloud_cover", "sortby"],
            "capabilities": {
                "temporal_filtering": False,
                "cloud_filtering": False,
                "spatial_filtering": True,
    ...
    "noaa-climate-normals-netcdf": {
        ...
        "resolution": "4km",
        "status": "good",
        "visualization": {"type": "climate_normals", "renderer": "climate_gridded"},
    ...
    "ms-buildings": {
        ...
        "resolution": "vector",
        "status": "excellent",
        "visualization": {"type": "building_footprints", "renderer": "vector_overlay"},
        "temporal": {"static": True},
    ...
    "us-census": {
        ...
        "status": "excellent",
        "visualization": {"type": "demographic_data", "renderer": "census_choropleth"},
    ...
    "modis-10A1-061": {
        ...
        "resolution": "500m",
        "status": "excellent",
        "visualization": {"type": "snow_cover", "renderer": "snow_colormap"},
    ...
    "modis-17A3HGF-061": {
        ...
        "resolution": "500m",
        "status": "excellent",
        "visualization": {"type": "productivity", "renderer": "npp_colormap"},
...
def get_query_rules(collection_id: str) -> Dict[str, Any]:
    ...
    if collection_id in COLLECTION_PROFILES:
        return COLLECTION_PROFILES[collection_id].get(
            "query_rules", _get_default_query_rules()
        )
...
def check_collection_coverage(collection_id: str, bbox: list) -> dict:
    ...
    if collection_id not in COLLECTION_PROFILES:
        return {
            "covered": True,
            "message": "Unknown collection, cannot verify coverage",
        }
    ...
    if not geo_extent:
        ...
        return {
            "covered": True,
            "message": "Collection has global or unspecified coverage",
        }
    ...
    if collection_bboxes:
        ...
        for collection_bbox in collection_bboxes:
            ...
            overlaps = not (
                query_east < coll_west
                or query_west > coll_east
                or query_north < coll_south
                or query_south > coll_north
            )
        ...
        if not overlaps_any:
            ...
            exclusion_text = (
                f" (excludes: {', '.join(exclusions)})" if exclusions else ""
            )
